...
/*THIS NEED TO BE IN FreeRTOSConfig.h SO CHANGES MAY BE REQUIRED*/
...
//#define ipconfigUSE_DHCP                        0 //NOTICE: THIS MAY BE IMPORTANT
...
/* The application must provide an xApplicationDHCPUserHook() implementation
when ipconfigDHCP_USES_USER_HOOK is set to 1. */
...
// ipconfigHTTP_RX_BUFSIZE                 ( 4 * ipconfigTCP_MSS )
